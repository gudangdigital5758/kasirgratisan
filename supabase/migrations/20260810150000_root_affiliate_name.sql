-- Root affiliator: nama resmi "Profitku Affiliate" (bukan nama akun Google).
update public.affiliates
set name = 'Profitku Affiliate'
where upper(code) = 'PROFITKU'
  and name is distinct from 'Profitku Affiliate';

-- Konsistensi bila reset one-off dijalankan lagi: root selalu bernama ini.
...
begin
  ...
  values ('PROFITKU', 'Profitku Affiliate', keep_id, null, true)
