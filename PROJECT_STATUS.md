...
- Worker produksi di-deploy ulang ke `94121a92` (memuat hardening c206293 + FUL-010 removal 837444c + fix merge raw 98087d6). `AUTO_FAIL_STALE_PENDING=true` aktif → PENDING >48 jam ke depan otomatis di-FAILED oleh cron harian.
